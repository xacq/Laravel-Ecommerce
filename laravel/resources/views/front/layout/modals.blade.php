                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <!-- Product-zoom-area -->
                            <div class="zoom-area">
                                <img id="zoom-pro-quick-view" class="img-fluid" src="{{ asset('front/images/product/product@4x.jpg') }}" data-zoom-image="{{ asset('front/images/product/product@4x.jpg') }}" alt="Ambato Shop Zoom Image">
                                <div id="gallery-quick-view" class="u-s-m-t-10">
                                    <a class="active" href="{{ asset('front/images/product/product@4x.jpg') }}" target="_blank" data-image="{{ asset('front/images/product/product@4x.jpg') }}" data-zoom-image="{{ asset('front/images/product/product@4x.jpg') }}">
                                        <img src="{{ asset('front/images/product/product@2x.jpg') }}" alt="Ambato Shop Producto">
                                    </a>
                                    <a href="{{ asset('front/images/product/product@4x.jpg') }}" data-image="{{ asset('front/images/product/product@4x.jpg') }}" data-zoom-image="{{ asset('front/images/product/product@4x.jpg') }}" target="_blank" rel="noopener noreferrer">
                                        <img src="{{ asset('front/images/product/product@2x.jpg') }}" alt="Ambato Shop Producto">
                                    </a>
                                    <a href="{{ asset('front/images/product/product@4x.jpg') }}" data-image="{{ asset('front/images/product/product@4x.jpg') }}" data-zoom-image="{{ asset('front/images/product/product@4x.jpg') }}" target="_blank" rel="noopener noreferrer">
                                        <img src="{{ asset('front/images/product/product@2x.jpg') }}" alt="Ambato Shop Producto">
