...
<head>
    ...
    <meta name="description" content="Ambato Shop es la mejor página para realizar tus compras en línea">
    <meta name="keywords" content="{{ $product->keywords ?? 'ambato', 'shopping', 'comercio', 'compras'  }}">
    <meta name="author" content="Ambato Shop">
    <title>@if(!empty($meta_titulo)){{ $meta_titulo }} @else Ambato Shop @endif</title>
...
<div class="loader">
   <img src="{{ asset('front/images/loaders/lg.gif') }}" alt="Ambato Shop loading..." />
</div>
