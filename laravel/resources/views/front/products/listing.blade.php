        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-9 col-sm-12">
                    ...
                    <div class="page-bar clearfix">
                            ...
                            <div class="toolbar-sorter">
                                <div class="select-box-wrapper">
                                    ...
                                    <select name="sort" id="sort" class="select-box">
                                        <!-- <option selected="selected" value="">Ordenar por: Más vendidos</option> -->
                                        <option selected="" value="">Seleccionar</option>   
                                        <option value="product_latest" @if(isset($_GET['sort']) && $_GET['sort']=="product_latest") selected="" @endif>Ordenar por: Último</option>
                                        ...
                                        <!-- <option value="">Ordenar por: Mejor calificación</option> -->
                                    </select>
                                </div>
                            </div>
                        </form>
                        ...
                        <div class="toolbar-sorter-2">
                            <div class="select-box-wrapper">
                                <label class="sr-only" for="show-records">Show Records Per Page</label>
                                <select class="select-box" id="show-records">
                                    <option selected="selected" value="">Muestra: {{ count($categoryProducts) }}</option>
                    ...
                    @endif
                    <div>&nbsp;</div>
                    <div>{{ $categoryDetails['categoryDetails']['descripcion'] }} </div>
                </div>
                <!-- Shop-Right-Wrapper /- -->
