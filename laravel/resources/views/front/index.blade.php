                                    ...
                                    <div class="item">
                                        <div class="image-container">
                                            ...
                                            <div class="item-action-behaviors">
                                                ...
                                                <a class="item-mail" href="#" onclick="event.preventDefault(); openMail();">Mail</a>
                                                <a class="item-addwishlist" href="#" onclick="event.preventDefault(); addToWishlist();">Add to Wishlist</a>
                                                <a class="item-addCart" href="#" onclick="event.preventDefault(); addToCart();">Add to Cart</a>
                                            </div>
                                        </div>
